...
NeuroRobotCommunicationBase::NeuroRobotCommunicationBase()
{
}
...
void NeuroRobotCommunicationBase::SetSocket(igtl::Socket *socket)
{
  this->Socket = socket;
}

int NeuroRobotCommunicationBase::ReceiveMessageHeader(igtl::MessageHeader *headerMsg, bool timeout)
{
...
int NeuroRobotCommunicationBase::CheckAndReceiveStringMessage(igtl::MessageHeader *headerMsg,
...
int NeuroRobotCommunicationBase::CheckAndReceiveStatusMessage(igtl::MessageHeader *headerMsg,
...
int NeuroRobotCommunicationBase::CheckAndReceiveTransformMessage(igtl::MessageHeader *headerMsg,
...
int NeuroRobotCommunicationBase::SkipMesage(igtl::MessageHeader *headerMsg)
{
...
int NeuroRobotCommunicationBase::SendStringMessage(const char *name, const char *string)
{
...
int NeuroRobotCommunicationBase::SendTransformMessage(const char *name, igtl::Matrix4x4 &matrix)
{
...
int NeuroRobotCommunicationBase::SendStatusMessage(const char *name, int Code, int SubCode,
...
void NeuroRobotCommunicationBase::GetRandomTestMatrix(igtl::Matrix4x4 &matrix)
{
  float position[3];
  float orientation[4];
...
int NeuroRobotCommunicationBase::ReceiveTransform(igtl::MessageHeader *header, igtl::Matrix4x4 &matrix)
{
...
int NeuroRobotCommunicationBase::ReceiveString(igtl::MessageHeader *header, std::string &string)
{
...
int NeuroRobotCommunicationBase::ReceiveStatus(igtl::MessageHeader *header, int &code, int &subcode,
...
void NeuroRobotCommunicationBase::PrintMatrix(std::string prefix, const igtl::Matrix4x4 &matrix)
{
...
int NeuroRobotCommunicationBase::ValidateMatrix(const igtl::Matrix4x4 &matrix)
{
...
int NeuroRobotCommunicationBase::CompareMatrices(const igtl::Matrix4x4 &matrix1, const igtl::Matrix4x4 &matrix2, double tol)
{

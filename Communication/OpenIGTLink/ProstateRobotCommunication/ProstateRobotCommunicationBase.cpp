...
ProstateRobotCommunicationBase::ProstateRobotCommunicationBase()
{
}
...
void ProstateRobotCommunicationBase::SetSocket(igtl::Socket *socket)
{
  this->Socket = socket;
}

int ProstateRobotCommunicationBase::ReceiveMessageHeader(igtl::MessageHeader *headerMsg, bool timeout)
{
...
int ProstateRobotCommunicationBase::CheckAndReceiveStringMessage(igtl::MessageHeader *headerMsg,
...
int ProstateRobotCommunicationBase::CheckAndReceiveStatusMessage(igtl::MessageHeader *headerMsg,
...
int ProstateRobotCommunicationBase::CheckAndReceiveTransformMessage(igtl::MessageHeader *headerMsg,
...
int ProstateRobotCommunicationBase::SkipMesage(igtl::MessageHeader *headerMsg)
{
...
int ProstateRobotCommunicationBase::SendStringMessage(const char *name, const char *string)
{
...
int ProstateRobotCommunicationBase::SendTransformMessage(const char *name, igtl::Matrix4x4 &matrix)
{
...
int ProstateRobotCommunicationBase::SendStatusMessage(const char *name, int Code, int SubCode,
...
void ProstateRobotCommunicationBase::GetRandomTestMatrix(igtl::Matrix4x4 &matrix)
{
  float position[3];
  float orientation[4];
...
int ProstateRobotCommunicationBase::ReceiveTransform(igtl::MessageHeader *header, igtl::Matrix4x4 &matrix)
{
...
int ProstateRobotCommunicationBase::ReceiveString(igtl::MessageHeader *header, std::string &string)
{
...
int ProstateRobotCommunicationBase::ReceiveStatus(igtl::MessageHeader *header, int &code, int &subcode,
...
void ProstateRobotCommunicationBase::PrintMatrix(std::string prefix, const igtl::Matrix4x4 &matrix)
{
...
int ProstateRobotCommunicationBase::ValidateMatrix(const igtl::Matrix4x4 &matrix)
{
...
int ProstateRobotCommunicationBase::CompareMatrices(const igtl::Matrix4x4 &matrix1, const igtl::Matrix4x4 &matrix2, double tol)
{

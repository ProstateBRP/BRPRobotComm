...
void *OpenIGTLink::ThreadIGT(void *igt)
{
    ...
    igtModule->WorkphaseList.push_back(new ProstateRobotUndefinedPhase(igtModule->robot));
    igtModule->WorkphaseList.push_back(new ProstateRobotStartUpPhase(igtModule->robot));
    igtModule->WorkphaseList.push_back(new ProstateRobotPlanningPhase(igtModule->robot));
    igtModule->WorkphaseList.push_back(new ProstateRobotCalibrationPhase(igtModule->robot));
    igtModule->WorkphaseList.push_back(new ProstateRobotTargetingPhase(igtModule->robot));
    igtModule->WorkphaseList.push_back(new ProstateRobotMoveToTargetPhase(igtModule->robot));
    igtModule->WorkphaseList.push_back(new ProstateRobotManualPhase(igtModule->robot));
    igtModule->WorkphaseList.push_back(new ProstateRobotStopPhase(igtModule->robot));
    igtModule->WorkphaseList.push_back(new ProstateRobotEmergencyPhase(igtModule->robot));

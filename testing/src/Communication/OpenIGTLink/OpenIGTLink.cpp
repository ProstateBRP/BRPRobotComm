...
// template <>
// int OpenIGTLink<NeuroRobot>::Session()
// {
//     // Set socket and robot status
//     std::vector<shared_ptr<NeuroRobotPhaseBase>>::iterator iter;
//     for (iter = neuro_workphase_list.begin(); iter != neuro_workphase_list.end(); iter++)
//     {
//         (*iter)->SetSocket(socket);
//         (*iter)->connect = true;
//         (*iter)->SetRobot(robot);
//         (*iter)->SetRobotStatus(make_shared<NeuroRobotStatus>(robot));
//     }
//     // Set undefined phase as the current phase;
//     std::vector<shared_ptr<NeuroRobotPhaseBase>>::iterator currentPhase = neuro_workphase_list.begin();
//     // Update robot state
//     this->robot->current_state = (*currentPhase)->Name();
...
// template <>
// void *OpenIGTLink<NeuroRobot>::ThreadIGT(void *igt)
// {
//     // Setup robot-specific states
//     OpenIGTLink<NeuroRobot> *igtModule = (OpenIGTLink<NeuroRobot> *)igt;
//     igtModule->neuro_workphase_list.push_back(make_shared<NeuroRobotUndefinedPhase>());
//     igtModule->neuro_workphase_list.push_back(make_shared<NeuroRobotStartUpPhase>());
//     igtModule->neuro_workphase_list.push_back(make_shared<NeuroRobotPlanningPhase>());
//     igtModule->neuro_workphase_list.push_back(make_shared<NeuroRobotCalibrationPhase>());
//     igtModule->neuro_workphase_list.push_back(make_shared<NeuroRobotTargetingPhase>());
//     igtModule->neuro_workphase_list.push_back(make_shared<NeuroRobotMoveToTargetPhase>());
//     igtModule->neuro_workphase_list.push_back(make_shared<NeuroRobotDrapingPhase>());
//     igtModule->neuro_workphase_list.push_back(make_shared<NeuroRobotManualPhase>());
//     igtModule->neuro_workphase_list.push_back(make_shared<NeuroRobotStopPhase>());
//     igtModule->neuro_workphase_list.push_back(make_shared<NeuroRobotEmergencyPhase>());
